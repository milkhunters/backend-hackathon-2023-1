...
Реализацию фронтедна для данного бэкенда можно найти во [втором репозитории.](https://github.com/milkhunters/frontend2-hackathon-2023-1)
...
Для проксирования трафика используется Traefik.
